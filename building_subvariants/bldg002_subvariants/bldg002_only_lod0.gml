<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  <cityObjectMember>
    <bldg:Building gml:id="bldg_002">
      <gml:description>bldg002_only_lod0 is a building object which has only one boundary (GroundSurface) and linked LOD representation as MultiSurface</gml:description>
      ...
      <boundary>
        <con:GroundSurface gml:id="bldg_002_groundsurface">
          ...
          <lod0MultiSurface>
            <gml:MultiSurface gml:id="bldg_002_groundsurface_l0_multisurface" srsDimension="3">
              <gml:surfaceMember>
                <gml:Polygon gml:id="bldg_002_groundsurface_l0_multisurface_polygon_001">
                  <gml:exterior>
                    <gml:LinearRing>
      ...
      <lod0MultiSurface xlink:href="#bldg_002_groundsurface_l0_multisurface"/>
      <con:height>
        <con:Height>
