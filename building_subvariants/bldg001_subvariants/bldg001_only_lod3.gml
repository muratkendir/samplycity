<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  <gml:name>Building 001</gml:name>
  <gml:boundedBy>
  ...
  <cityObjectMember>
    <bldg:Building gml:id="building_01">
      <gml:description>bldg001_only_lod3 is a building object which has only LOD3 representation as Solid</gml:description>
        ...
        <gml:Solid gml:id="building_01_lod_3_solid" srsDimension="3">
          <gml:exterior>
            <gml:Shell>
              ...
              <gml:surfaceMember>
                <gml:Polygon gml:id="bbuilding_01_lod_3_solid_polygon_002">
                  <gml:exterior>
                    <gml:LinearRing>
