        ...
        <con:RoofSurface gml:id="bldg_002_roofsurface">
          ...
          <lod2MultiSurface>
            <gml:MultiSurface gml:id="bldg_002_roofsurface_l2_multisurface" srsDimension="3">
              ...
              <gml:surfaceMember>
                <gml:Polygon gml:id="bldg_002_roofsurface_l1_multisurface_polygon_002">
                  <gml:exterior>
                    <gml:LinearRing>
              ...
              <gml:surfaceMember>
                <gml:Polygon gml:id="bldg_002_roofsurface_l1_multisurface_polygon_003">
                  <gml:exterior>
                    <gml:LinearRing>
              ...
              <gml:surfaceMember>
                <gml:Polygon gml:id="bldg_002_roofsurface_l1_multisurface_polygon_004">
                  <gml:exterior>
                    <gml:LinearRing>
