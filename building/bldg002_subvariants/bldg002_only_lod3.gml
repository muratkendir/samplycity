<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  <cityObjectMember>
    <bldg:Building gml:id="bldg_002">
      <gml:description>bldg002_only_lod3 is a building object which has boundaries (GroundSurface, RoofSurface & WallSurface) and linked LOD representation as Solid</gml:description>
      <gml:name>Building 02</gml:name>
