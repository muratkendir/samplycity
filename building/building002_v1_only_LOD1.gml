    ...
    <bldg:Building gml:id="building_02">
      ...
      <boundary>
        <con:GroundSurface gml:id="building_02_groundsurface">
          ...
          <lod1MultiSurface>
            <gml:MultiSurface gml:id="building_02_groundsurface_l1_multisurface" srsDimension="3">
              <gml:surfaceMember>
                <gml:Polygon gml:id="building_02_groundsurface_l1_multisurface_polygon_001">
                  <gml:exterior>
                    <gml:LinearRing>
      ...
      <boundary>
        <con:WallSurface gml:id="building_02_wallsurface_01">
          ...
          <lod1MultiSurface>
            <gml:MultiSurface gml:id="building_02_wallsurface_01_l1_multisurface" srsDimension="3">
              <gml:surfaceMember>
                <gml:Polygon gml:id="building_02_wallsurface_01_l1_multisurface_polygon_001">
                  <gml:exterior>
                    <gml:LinearRing>
      ...
      <boundary>
        <con:WallSurface gml:id="building_02_wallsurface_02">
          ...
          <lod1MultiSurface>
            <gml:MultiSurface gml:id="building_02_wallsurface_02_l1_multisurface" srsDimension="3">
              <gml:surfaceMember>
                <gml:Polygon gml:id="building_02_wallsurface_02_l1_multisurface_polygon_001">
                  <gml:exterior>
                    <gml:LinearRing>
      ...
      <boundary>
        <con:WallSurface gml:id="building_02_wallsurface_03">
          ...
          <lod1MultiSurface>
            <gml:MultiSurface gml:id="building_02_wallsurface_03_l1_multisurface" srsDimension="3">
              <gml:surfaceMember>
                <gml:Polygon gml:id="building_02_wallsurface_03_l1_multisurface_polygon_001">
                  <gml:exterior>
                    <gml:LinearRing>
      ...
      <boundary>
        <con:WallSurface gml:id="building_02_wallsurface_04">
          ...
          <lod1MultiSurface>
            <gml:MultiSurface gml:id="building_02_wallsurface_04_l1_multisurface" srsDimension="3">
              <gml:surfaceMember>
                <gml:Polygon gml:id="building_02_wallsurface_04_l1_multisurface_polygon_001">
                  <gml:exterior>
                    <gml:LinearRing>
      ...
      <lod1Solid>
        <gml:Solid gml:id="building002_lod_l1_solid">
          <gml:exterior>
            <gml:Shell>
              <gml:surfaceMember xlink:href="#building_02_groundsurface_l1_multisurface_polygon_001"/>
              <gml:surfaceMember xlink:href="#building_02_roofsurface_l1_multisurface_polygon_001"/>
              <gml:surfaceMember xlink:href="#building_02_wallsurface_01_l1_multisurface_polygon_001"/>
              <gml:surfaceMember xlink:href="#building_02_wallsurface_02_l1_multisurface_polygon_001"/>
              <gml:surfaceMember xlink:href="#building_02_wallsurface_03_l1_multisurface_polygon_001"/>
              <gml:surfaceMember xlink:href="#building_02_wallsurface_04_l1_multisurface_polygon_001"/>
            </gml:Shell>
          </gml:exterior>
        </gml:Solid>
      </lod1Solid>
