<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
  ...
  <gml:name>Vegetation 003</gml:name>
  <gml:boundedBy>
  ...
  <cityObjectMember>
    <veg:PlantCover gml:id="veg_003">
      <gml:description>Veg003, a plant cover which has only LOD0 representation as MultiSurface</gml:description>
      <gml:name>Vegetation 003</gml:name>
      <creationDate>2024-03-11T00:00:00</creationDate>
      <lod0MultiSurface>
        <gml:MultiSurface gml:id="veg_003_l0_multisurface" srsDimension="3">
              <gml:surfaceMember>
                <gml:Polygon gml:id="veg_003_l0_multisurface_polygon_001">
                  <gml:exterior>
                    <gml:LinearRing>
